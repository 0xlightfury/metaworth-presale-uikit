...
export const Anchors: React.FC = () => {
  return (
    <>
      ...
      <Box>
        <Button as="a" href="https://app.metaworth.exchange" mr="8px" external disabled>
          Disabled
        </Button>
        <Button as="a" href="https://app.metaworth.exchange" variant="secondary" external disabled>
          Disabled
        </Button>
      </Box>
    </>
